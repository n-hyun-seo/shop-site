  ...
  return (
    <div className="home-page">
      ...
      <div className="content">
        ...
        <p className="delivery-sub-text">**Expected delivery date may vary depending on stock and demand.</p>
      </div>
      <img className="chat-agent" src="https://www.mayernetworks.com/wp-content/uploads/2021/07/support-icon.png" alt="support"></img>
    </div>
  );
}
